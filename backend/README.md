...
## Project Structure
    ...
    ├── testapiautoconnect_108578  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_108578`
...
2. Clone this repo and `cd testapiautoconnect_108578`
